...
public class DisplaylistController implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        if(event.getSource()==personaldetails){
            Parent parent= FXMLLoader.load(getClass().getResource("personaldisplay.fxml"));
        ...
        if(event.getSource()==educationaldetails){
            Parent parent = FXMLLoader.load(getClass().getResource("educationaldisplay.fxml"));
           Scene scene = new Scene(parent);
           Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
           stage.setScene(scene);
        ...
        if(event.getSource()==financialdetails){
            Parent parent = FXMLLoader.load(getClass().getResource("financialdisplay.fxml"));
           Scene scene = new Scene(parent);
           Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
           stage.setScene(scene);
        ...
        if(event.getSource()==medicaldetails){
            Parent parent = FXMLLoader.load(getClass().getResource("medicaldisplay.fxml"));
           Scene scene = new Scene(parent);
           Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
           stage.setScene(scene);
        ...
        if(event.getSource()==govdetails){
            Parent parent = FXMLLoader.load(getClass().getResource("govdisplay.fxml"));
           Scene scene = new Scene(parent);
           Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
           stage.setScene(scene);
